...
export interface SettingsDefaults {
  ...
  CLAUDE_MEM_OPENROUTER_THINKING: string;
...
export class SettingsDefaultsManager {
  private static readonly DEFAULTS: SettingsDefaults = {
    ...
    CLAUDE_MEM_OPENROUTER_THINKING: '',  // #1 — optional thinking.type toggle for MiMo-style gateways: "enabled" or "disabled". Empty = omit (endpoint default).
