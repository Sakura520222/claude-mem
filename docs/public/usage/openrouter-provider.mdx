...
| `CLAUDE_MEM_OPENROUTER_BASE_URL` | string | — | Optional: point the client at any OpenAI-compatible endpoint (DeepSeek, LM Studio, etc.). See [Custom Provider](/usage/custom-provider). |
