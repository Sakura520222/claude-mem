...
- Prompt for an LLM provider (Claude Code auth, Gemini API key, OpenRouter API key, or a custom OpenAI-compatible endpoint such as DeepSeek, OpenAI, LM Studio, Ollama, or vLLM)
